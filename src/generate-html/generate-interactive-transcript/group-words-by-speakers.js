/**
 * https://github.com/bbc/react-transcript-editor/blob/master/packages/stt-adapters/digital-paper-edit/group-words-by-speakers.js
 edge cases
...
*
* Takes in list of words and list of paragraphs
* (paragraphs have speakers info associated with it)
```js
{
  "words": [
    {
...
module.exports = groupWordsInParagraphsBySpeakers;